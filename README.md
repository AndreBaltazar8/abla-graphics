...
- a pure-Abla, deterministic Khronos XML inventory generator with pinned and
  ...
  unclassified; exact ABI-family metadata currently enables 2,666 OpenGL
  ...
  argument and repeated mixed-layout families. OpenGL retains 225 explicitly
...
- `examples/raw-command-addresses`: resolves generated OpenGL and Vulkan
  ...
  boolean, unsigned, and signed query results. Over-width color/depth mask
