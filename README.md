...
- a direct pure-Abla Wayland transport that resolves the configured compositor
  ...
  tracking, direct integer buffer scale/transform state, optional per-surface
  fractional-scale preferences,
  ...
  decoration negotiation, direct idle inhibition, and ordered teardown
