...
| `glBlitFramebuffer` | definition | unclassified |
...
| `glClearBufferfv` | definition | unclassified |
...
| `glCopyImageSubData` | definition | unclassified |
...
| `glDrawBuffers` | definition | unclassified |
...
| `glFramebufferTexture2D` | definition | unclassified |
...
| `glGenerateTextureMipmap` | definition | unclassified |
...
| `glGetTextureSubImage` | definition | unclassified |
...
| `glInvalidateFramebuffer` | definition | unclassified |
...
| `glReadBuffer` | definition | unclassified |
...
| `glTexImage2DMultisample` | definition | unclassified |
