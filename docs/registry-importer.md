...
variants, and emits a byte-sorted coverage ledger. OpenGL compatibility-only
...
4. feature and extension negotiation metadata; and
5. a ledger classification joined to loader, ABI, positive-test, and
