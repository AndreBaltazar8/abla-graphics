...
uniform/storage buffers and sampled textures/samplers through a flattened
affine resource table,
...
unchanged. Later slices must add sampled texture-view and transient-texture
