...
uniform/storage buffers and sampled textures/views/samplers through a
flattened affine resource table,
...
unchanged. Later slices must add transient sampled-texture subpass forms,
