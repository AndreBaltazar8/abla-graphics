...
color/depth targets across every render form, single-color multisample resolve
targets with both imported identities,
...
unchanged. Later slices must add MRT/subpass render forms,
